...
%token DEF ANDDEF CLASS EXTENDS FIELDS METHODS NEW ADD1 SUB1 LPARENSPACE LPARENNOSPACE RPAREN LBRACK RBRACK LBRACE RBRACE LET IN OF EQUAL COMMA PLUS MINUS TIMES IF COLON ELSECOLON EOF PRINT PRINTSTACK TRUE FALSE ISBOOL ISNUM EQEQ LESSSPACE LESSNOSPACE GREATER LESSEQ GREATEREQ AND OR NOT THINARROW COLONEQ SEMI DOT NIL TYPE LAMBDA BEGIN END REC UNDERSCORE
...
simple_expr :
  ...
  | id { $1 }
  // Object stuff
  | simple_expr DOT LBRACK ID RBRACK { EGetField($1, $4, full_span()) }
